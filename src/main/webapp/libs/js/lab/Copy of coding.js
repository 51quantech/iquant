...
function setChartDesc(data){
	...
	var beta =  flag ? '' : data.beta.toFixed(2);//
	var sharpeRatio =  flag ? '' : data.sharpeRatio.toFixed(2);//
	var volatility =  flag ? '' : (Number(data.volatility) * 100).toFixed(2) + "%";
	var informationRatio =  flag ? '' : data.informationRatio.toFixed(2);//
	var maxDrawdown =  flag ? '' : (Number(data.maxDrawdown) * 100).toFixed(2) + "%";
	var turnoverRate =  flag ? '' : data.turnoverRate.toFixed(2);//
