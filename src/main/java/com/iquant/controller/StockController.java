...
public class StockController {
    ...
    public void getStockInfoAll(HttpServletResponse response) throws IOException {
        ...
        response.getWriter().print(STOCK_CONTENT);
    }
